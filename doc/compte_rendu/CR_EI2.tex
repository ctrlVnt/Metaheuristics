...
Paramètres de test pour les graphiques :
 ...
 \begin{figure}[h!]
    ...
    \begin{minipage}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{imgs/Examen_run_GRASP.png}
        \caption{Un run du GRASP}
        \label{fig:runGRASP}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.48\linewidth}
...
\end{figure}
 \begin{figure}[h!]
     \centering
     \includegraphics[width=0.5\linewidth]{imgs/bilan_CPUt_tous_runs_GRASP.png}
...
En conclusion, si la valeur optimale varie légèrement en fonction d'alpha, elle varie considérablement au fil du temps. En effet, pour une valeur élevée d'alpha, la liste RCL est plus courte, tandis que pour alpha = 0, elle contient beaucoup plus de candidats.
...
\begin{figure}[h!]
    ...
    \begin{minipage}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{imgs/Examen_run_PR.png}
        \caption{Un run du GRASP + PR}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\linewidth]{imgs/bilan_CPUt_tous_runs_PR.png}
    \caption{CPU temps d'execution}
    \label{fig:placeholder}
\end{figure}
